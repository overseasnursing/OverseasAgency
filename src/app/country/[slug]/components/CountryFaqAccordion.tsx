...
interface CountryFaqAccordionProps {
  faqs: CountryFAQ[]
  countryName: string
}

export function CountryFaqAccordion({ faqs, countryName }: CountryFaqAccordionProps) {
  if (faqs.length === 0) return null

  return (
    <section aria-labelledby="faq-heading">
      <h2 id="faq-heading" className="text-[22px] font-bold text-slate-800 mb-2">
        Frequently Asked Questions
      </h2>
      <p className="text-[14px] text-slate-500 mb-6">
        Common questions from Indian nurses planning to migrate to {countryName}.
      </p>
